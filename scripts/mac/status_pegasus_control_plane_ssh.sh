...
#
# Usage:
#   PEGASUS_HOST=<pegasus_host_or_alias> ./scripts/mac/status_pegasus_control_plane_ssh.sh
#   ./scripts/mac/status_pegasus_control_plane_ssh.sh <pegasus_host_or_alias>
