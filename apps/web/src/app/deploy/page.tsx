    ...
    <div className="mx-auto max-w-2xl space-y-8">
      ...
      <Card className="space-y-3">
        ...
        <div className="space-y-2 text-sm text-black/70">
          <p>
            1. Recover 3D motion from a phone video: <Link className="font-semibold underline" href="/gvhmr">Run motion recovery</Link>
          </p>
          <p>
            2. Run the full pipeline (dataset + training): <Link className="font-semibold underline" href="/studio">Open Studio</Link>
          </p>
        </div>
      </Card>
    </div>
