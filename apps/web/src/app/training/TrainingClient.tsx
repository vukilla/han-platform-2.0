    ...
    <div className="space-y-10">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <Card className="space-y-4">
          ...
          {selectedDataset ? <p className="text-xs text-black/60">Selected dataset: {selectedDataset.id}</p> : null}
          {jobId ? (
        ...
        <Card className="space-y-4">
          ...
          <p className="text-sm">Includes DI/IT/DR modules for generalization-first training across augmented distributions.</p>
        </Card>
      </div>
    </div>
  );
