...
HumanX-style gamma/lambda configuration lives in:

- `services/xmimic/xmimic/rewards/unified.py` (`HumanXRewardConfig`, `RewardTerm`, `load_reward_config`)
- `services/xmimic/configs/humanx_reward.yaml` (default values)
